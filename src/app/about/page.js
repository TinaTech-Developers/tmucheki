...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      <Head>
        <title>
          About Tmucheki Investments | Printing, Signage & Logistics Experts
        </title>
        <meta
          name="description"
          content="Learn more about T. Mucheki Investments — Zimbabwe's trusted partner in signage, printing, and logistics. Discover our story, values, and mission."
        />
        <meta
          name="keywords"
          content="T. Mucheki Investments, printing company Zimbabwe, signage services Zimbabwe, logistics solutions Zimbabwe, business branding, corporate signage, digital printing"
        />
        ...
        <meta
          property="og:title"
          content="About T. Mucheki Investments | Printing, Signage & Logistics Experts"
        />
        <meta
          property="og:description"
          content="Trusted by businesses across Zimbabwe for high-quality signage, printing, and logistics solutions."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.tmucheki.co.zw/about" />
        <meta property="og:site_name" content="Tmucheki Investments" />
        <meta
          property="og:image"
          content="https://www.tmucheki.co.zw/images/logo.png"
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              sameAs: [
                "https://www.facebook.com/tmuchekiinvestments",
                "https://www.linkedin.com/company/tmuchekiinvestments",
              ],
              description:
                "T. Mucheki Investments provides top-tier signage, printing, and logistics services across Zimbabwe.",
              address: {
                "@type": "PostalAddress",
                addressCountry: "ZW",
              },
