...
const projectCategories = [
  ...
  },
  {
    category: "Logistics",
    projects: [
      { title: "Truck Delivery", img: "/logistics/logistics7.jpeg" },
...
export default function ProjectsPage() {
  ...
  return (
    <>
      <Head>
        <title>
          Our Projects | T. Mucheki Investments - Signage, Printing & Logistics
        </title>
        <meta
          name="description"
          content="Explore T. Mucheki Investments projects — from creative signage and printing solutions to logistics and branding services across Zimbabwe."
        />
        <meta
          name="keywords"
          content="TinaSoft Nexus projects, signage in Zimbabwe, printing Harare, vehicle branding Zimbabwe, logistics services Harare, CNC cutting, DTF printing Zimbabwe"
        />
        ...
        <meta
          property="og:title"
          content="Our Projects | T. Mucheki Investments - Signage, Printing & Logistics"
        />
        <meta
          property="og:description"
          content="Take a look at some of our most successful signage, printing, and logistics projects at T. Mucheki Investments."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://tmucheki.co.zw/projects" />
        <meta property="og:image" content="https://tmucheki.co.zw/logo.png" />
        ...
        <meta
          ...
          content="Take a look at some of our most successful signage, printing, and logistics projects at T. Mucheki Investments."
        />
        <meta name="twitter:image" content="https://tmucheki.co.zw/logo.png" />
      </Head>
