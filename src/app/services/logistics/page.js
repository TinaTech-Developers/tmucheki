...
export default function LogisticsServicesPage() {
  ...
  return (
    <>
      <Head>
        <title>Logistics & Transport Services | Tmucheki Investments</title>
        <meta
          name="description"
          content="Reliable logistics and transport services in Zimbabwe. Truck delivery, warehouse management, cross-border shipping, and fleet tracking by T. Mucheki Investments."
        />
        <meta
          name="keywords"
          content="Logistics Zimbabwe, Transport Services Zimbabwe, Truck Delivery, Warehouse Management, Fleet Tracking, Cross-border Shipping, T. Mucheki Investments"
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://tmucheki.co.zw/logistics" />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="Logistics & Transport Services | T. Mucheki Investments"
        />
        <meta
          property="og:description"
          content="Reliable logistics and transport services in Zimbabwe by T. Mucheki Investments."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://tmucheki.co.zw/logistics" />
        <meta
          property="og:image"
          content="https://tmucheki.co.zw/logistics5.jpeg"
        />
        ...
        <meta
          name="twitter:image"
          content="https://tmucheki.co.zw/og-logistics.jpg"
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              url: "https://tmucheki.co.zw/logistics",
              logo: "https://tmucheki.co.zw/logo.png",
              description:
                "Reliable logistics and transport services in Zimbabwe including truck delivery, warehouse management, cross-border shipping, and fleet tracking.",
              image: "https://tmucheki.co.zw/logistics5.jpeg",
              sameAs: [
                "https://www.facebook.com/tmucheki",
                "https://www.linkedin.com/company/tmucheki",
              ],
              areaServed: "Zimbabwe",
              serviceType: ["Logistics", "Transport", "Fleet Tracking"],
            }),
          }}
        />
      </Head>
          ...
          <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="mt-6 text-gray-400 text-lg leading-relaxed">
                At <span className="text-blue-400">Tmucheki Investments</span>,
                we go beyond providing services. We deliver{" "}
